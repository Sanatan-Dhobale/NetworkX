import { getAllPosts, createPost, postComment, deletePost, incrementPostLike, getAllComments, handleShare } from '@/config/redux/action/postAction';
      ...
      <DashboardLayout>
        ...
        <div className={styles.scrollComponent}>
          ...
          <div className={styles.createPostContainer}>
            ...
            }} className={styles.textArea} value={postContent} placeholder='Share your thoughts...' name="" id=""></textarea>
            ...
            {postContent.length > 0 && <div onClick={handleUpload} className={styles.uploadButton}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
...

                          {
                            ...
                            <svg onClick={async () => {
                              ...
                              dispatch(getAllPosts())
                            }} style={{ cursor: "pointer", height: "20px", color: "red" }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <div onClick={(e)=>{
...

              {
                ...
                <div className={styles.commentsList}>
                  <h2>Comments</h2>
                  {
                    postState.comments.comments.map((postComment, index)=>{
                      return (
